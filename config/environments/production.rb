...
Rails.application.configure do
  ...
  # Use memory store for now until we set up multiple databases properly
  # config.cache_store = :solid_cache_store
  config.cache_store = :memory_store

  # Use default queue adapter for now
  ...
  config.action_mailer.default_url_options = { host: "getuplo.com", protocol: "https" }
  ...
  # Resend SMTP settings for production
